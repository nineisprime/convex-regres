...
\begin{abstract} 
There are two review cycles for ICML 2014, with full paper submissions 
due on October 4, 2013 and January 31, 2014. Reviewing 
...
Submissions must be in PDF, with an 8 page length limit ( 9 pages are allowed if the 9-th page contains \emph{only} references).
\end{abstract} 
