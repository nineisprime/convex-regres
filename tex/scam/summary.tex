...
we analyze the finite sample variable selection consistency of AC/DC under the model
\[
y_i = f_0(X_i) + w_i \quad \textrm{for $i=1,...,n$, }
\]
without assuming that the true
