...
\begin{definition}
  ...
  satisfies the \emph{boundary flatness condition} if it satisfies certain regularity conditions (see precise statement in Definition~\ref{defn:boundary-point}) and if for all $j$, and
