...
\runtitle{Supplement to Faithful Variable Screening for Convex Regression}
\end{frontmatter}
...
\textbf{Step 2.} We now bound term 3, by writing
\begin{align*}
\| f_0 - & \hat{f} - g^*_k \|_P^2 - \| f_0 - f^* - g^*_k\|_P^2 \\
& \leq 
