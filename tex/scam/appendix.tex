...
\begin{align*}
\partial d_k :& \qquad -\frac{1}{n} \Delta_k^\tran ( \hat{r}_k - \Delta_k \hat{d}_k + \hat{c}_k \mathbf{1}) + \lambda \mathbf{u}_k  - \mu_k - \gamma_k \Delta_k^\tran \mathbf{1} \\
\partial c_k: & \qquad -\frac{1}{n} \mathbf{1}^\tran ( \hat{r}_k - \Delta_k d_k + c_k \mathbf{1}) + \gamma_k
\end{align*}
