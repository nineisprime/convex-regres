...
\ref{Boston}(e). When refitting, we constrain a component to be convex if it is non-zero in the AC stage and concave only if it is non-zero in the DC stage. As can be seen, these functions contain clear
