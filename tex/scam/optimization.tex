...
\subsection{Convex-plus-concave Functions}
...
\subfigure[$|x| - (x-0.1)^2$]{
   \centering
   {\includegraphics[width=0.3\textwidth]{concavex1.pdf}}
}
\subfigure[$0.5(x-0.3)^4 - x^2$]{
   \centering
   {\includegraphics[width=0.3\textwidth]{concavex2.pdf}}
}
\subfigure[$0.5 x^2 + 1 - x^4$]{
   \centering
   {\includegraphics[width=0.3\textwidth]{concavex3.pdf}}
}
\caption{Examples of one-dimensional concave-plus-convex functions.}
\label{fig:concavex}
\end{figure}

% examples of convex + concave functions
% no additive faithfulness
