...
This theorem naturally suggests a two-stage screening procedure for
...
we fit a univariate \emph{concave} function on the residual for
that variable. We refer to this procedure as AC/DC (additive
convex / decoupled concave) and describe it in more detail in
Section~\ref{sec:acdc}.
...
Fix $k$. Let $f^*_k$ and $g^*_k$'s be defined as in
