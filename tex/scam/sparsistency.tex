...
Suppose $\lambda \leq c_1 sB  \sqrt{\frac{1}{n} \log^2 np}$ and $n$ is large enough such that$\frac{n^{4/5}}{\log^2 np} \geq B^3 \sigma s^{2.5}$.  Suppose also that $\sigma \geq c_2$ for an arbitrarily small constant $c_2 > 0$. 

Suppose 
$\frac{\alpha_f}{\sigma} \geq c B^3 \sqrt{\frac{s^5}{n^{4/5}} \log^2 np}$ and $\frac{\alpha_g^2}{\sigma} \geq c B^3 \sqrt{\frac{s^5}{n^{4/5}} \log^2 2np}$, where $c$ is a constant dependent only on $b, c_1, c_2$.\\
...
$\lambda = \Theta \Big( sB \sqrt{\frac{1}{n} \log^2 np} \Big)$. Suppose $\sigma \geq c_2$ for an arbitrarily small constant $c_2 > 0$.\\


Suppose 
$\frac{\alpha_f}{\sigma} \geq c B^3 \sqrt{\frac{s^5}{n^{4/5}} \log^2 np}$ and $\frac{\alpha_g^2}{\sigma} \geq c B^3 \sqrt{\frac{s^5}{n^{4/5}} \log^2 2np}$ where $c$ is some constant dependent only on $b, c_2$.\\
