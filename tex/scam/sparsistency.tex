...
%Our goal is to show that, as $n \rightarrow \infty$ and $p$ scales as $exp(-n^c)$, we have that the set of variables outputted by  $\hat{S}$
...
screening procedure.  We then consider the
